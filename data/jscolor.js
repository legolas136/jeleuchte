...
var jsc = {
	...
	pub : function (targetElement, opts) {
		...
		this.width = 50; // width of color palette (in px)
		this.height = 30; // height of color palette (in px)
		...
		this.buttonHeight = 35; // px
		this.padding = 0; // px
		this.backgroundColor = 'rgba(150,150,100,1)'; // CSS color
		this.borderWidth = 1; // px
		this.borderColor = 'rgba(0,0,0,1)'; // CSS color
		this.borderRadius = 8; // px
		this.controlBorderWidth = 1; // px
		this.controlBorderColor = 'rgba(187,187,187,1)'; // CSS color
		this.shadow = false; // whether to display a shadow
		this.shadowBlur = 5; // px
		this.shadowColor = 'rgba(0,0,0,0.9)'; // CSS color
